...
export const ROLE_MAP: Record<AgentRole, RoleConfig> = {
  main: {
    ...
    accent: '#F0B429',
    softAccent: 'rgba(240, 180, 41, 0.18)',
    zone: 'lounge',
    home: { x: 16, y: 74 },
  },
  coordinator: {
    ...
    accent: '#E8A838',
    softAccent: 'rgba(232, 168, 56, 0.18)',
    zone: 'meeting',
    home: { x: 50, y: 71 },
  },
  builder: {
    ...
    summary: '负责实现与工具执行。',
    accent: '#56D0A0',
    softAccent: 'rgba(86, 208, 160, 0.18)',
    zone: 'workbench',
    home: { x: 79, y: 28 },
  },
  researcher: {
    ...
    accent: '#B88CF7',
    softAccent: 'rgba(184, 140, 247, 0.18)',
    zone: 'thinking',
    home: { x: 31, y: 21 },
  },
  reviewer: {
    ...
    summary: '负责检查细节与质量把关。',
    accent: '#5BB8E8',
    softAccent: 'rgba(91, 184, 232, 0.18)',
    zone: 'review',
    home: { x: 60, y: 28 },
  },
  ops: {
    ...
    accent: '#E05252',
    softAccent: 'rgba(224, 82, 82, 0.18)',
    zone: 'alert',
    home: { x: 84, y: 76 },
  },
};
...
export const ROOM_ZONE_META: Record<RoomZone, RoomZoneMeta> = {
  lounge: { label: '休息区', color: 'rgba(240, 180, 41, 0.12)', x: 4, y: 58, w: 24, h: 30 },
  thinking: { label: '思考区', color: 'rgba(184, 140, 247, 0.12)', x: 5, y: 6, w: 38, h: 26 },
  review: { label: '审查台', color: 'rgba(91, 184, 232, 0.11)', x: 47, y: 6, w: 20, h: 26 },
  workbench: { label: '工作区', color: 'rgba(86, 208, 160, 0.12)', x: 70, y: 6, w: 25, h: 30 },
  meeting: { label: '会议区', color: 'rgba(232, 168, 56, 0.11)', x: 34, y: 56, w: 32, h: 28 },
  alert: { label: 'Bug 区', color: 'rgba(224, 82, 82, 0.12)', x: 71, y: 62, w: 24, h: 24 },
};
